...
| H4 | Current official GitHub Pages, Cloudflare Web Analytics, Cloudflare Workers Logs, and Resend documentation cited in [`docs/PRIVACY_DATA_FLOW.md`](./PRIVACY_DATA_FLOW.md), checked 2026-08-12 | Public |
...
| WEB-07 | GitHub Pages visitor logging. | GitHub Pages currently serves the site. GitHub says it logs a visitor's IP address for security when a Pages site is visited. | H3, H4 | Public | None | Yes until the hosting migration. |
