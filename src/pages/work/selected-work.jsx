  ...
  return (
    <article className={`case-study${featured ? ' case-study--featured' : ''}${className ? ` ${className}` : ''}`}>
      ...
      <footer className="case-study__sources">
        ...
        <div>
          {sources.map((source) => (
            <Link className="text-link" key={source.label} to={source.to}>
              {source.label}
            </Link>
          ))}
        </div>
            ...
            <CaseStudy
              ...
              fields={[
                ...
                },
                {
                  ...
                  body: (
                    <>
                      The underlying source is not linked because it includes employer-specific workflow details and is
                      not confidentiality-safe.
                    </>
                  ),
                },
                {
                ...
                },
                {
                  ...
                  body: (
                    <>
                      The public sample loads two CSV exports, validates their schemas, normalizes identifiers, selects
                      the latest matching event, reconciles quantities, and writes explicit review reasons.
                    </>
                  ),
                },
                {
                  ...
                  body: (
                    <>
                      The public sample is a clean reconstruction with synthetic data. Its tests validate the sample,
                      not the employer system or historical outcome.
                    </>
                  ),
                },
                {
                  ...
                  body: (
                    <>
                      The working portion completed report gathering, normalization, reconciliation, and report
                      generation.
                    </>
                  ),
                },
                {
                  ...
                  body: (
                    <>
                      A later write-back step was not completed. No time saving, record count, business outcome, or
                      production benchmark is claimed.
                    </>
                  ),
                },
              ]}
        ...
        <section className="section-block section-soft selected-work-section">
          <div className="shell">
            <div className="section-heading case-section-heading">
              ...
              <p>
                EvoGen and Kenshi Agent Environment are public repositories, not commercial deployments or sprint
                products.
              </p>
            </div>
            ...
            <div className="case-study-stack">
              <CaseStudy
                ...
                fields={[
                  {
                    label: 'Situation',
                    body: <>EvoGen is an outer-loop capability engineering harness for autonomous agents.</>,
                  },
                  {
                    label: 'Constraints',
                    body: (
                      <>
                        Candidate changes are evaluated outside the runtime plane and promoted only through lineage
                        gates.
                      </>
                    ),
                  },
                  {
                    label: "Levi's role",
                    body: <>I am the primary author of the EvoGen repository at the pinned commit.</>,
                  },
                  {
                    label: 'Technical approach',
                    body: (
                      <>
                        The repository uses strict Pydantic contracts, append-only JSONL trajectories, a
                        content-addressed artifact store, and a SQLite ledger.
                      </>
                    ),
                  },
                  {
                    ...
                    body: (
                      <>
                        One verification command runs Ruff, strict mypy, schema checks, the full test suite, a
                        deterministic end-to-end proof in a disposable workspace, and a whitespace-error check.
                      </>
                    ),
                  },
                  {
                    label: 'Result',
                    body: <>The repository is a runnable alpha with one deterministic end-to-end prototype.</>,
                  },
                  {
                    label: 'What remains limited or unproven',
                    body: (
                      <>
                        It does not yet prove a real game integration or model-generated diagnosis. EvoGen includes a
                        small KAE JSONL normalization adapter. KAE is not yet registered as a complete EvoGen subject,
                        and its production trajectory exporter is not complete.
                      </>
                    ),
                  },
                ]}
                sources={[
                  ...
                  {
                    label: 'Read the pinned README',
                    to: 'https://github.com/libardo667/evogen/blob/c37147b3120c38c9a979ca8671fcc11c5ab62c6c/README.md',
                  },
                ]}
              />
              ...
              <CaseStudy
                ...
                fields={[
                  {
                    label: 'Situation',
                    body: <>Kenshi Agent Environment lets a language model play a supervised game of Kenshi.</>,
                  },
                  {
                    label: 'Constraints',
                    body: (
                  ...
                  {
                    label: "Levi's role",
                    body: <>I am the primary author of the Kenshi Agent Environment repository at the pinned commit.</>,
                  },
                  {
                    label: 'Technical approach',
                    body: (
                      <>
                        A native mod reads game state and performs gameplay actions. A Python runtime captures
                        screenshots, builds the actions that are valid at that moment, checks the model's choice against
                        fresh state, and records what happened.
                      </>
                    ),
                  },
                  {
                    ...
                    body: (
                      <>
                        Before dispatch, the runtime checks the model's choice against fresh state. The native mod
                        reports whether Kenshi accepted the action and what happened afterward. The runtime records the
                        observation, decision, command, and result. Mock and replay runs use the same planner and
                        operation path.
                      </>
                    ),
                  },
                  ...
                  },
                  {
                    ...
                    body: (
                      <>
                        No claim is made here about current action coverage, live-run results, full autonomy, production
                        readiness, or general game-playing capability.
                      </>
                    ),
                  },
                ]}
                sources={[
                  ...
                  {
                    label: 'Read the pinned README',
                    to: 'https://github.com/libardo667/kenshi-agent-env/blob/bfaa4d55ae10a34d33e7a06ee3959fc6659eceb4/README.md',
                  },
                ]}
              />
            </div>
          ...
          <div className="shell">
            ...
            <CaseStudy
              ...
              fields={[
                ...
                {
                  label: "Levi's role",
                  body: <>I am the primary author of the WorldWeaver repository at the pinned commit.</>,
                },
                {
                  label: 'Technical approach',
                  body: (
                    <>
                      WorldWeaver uses a Python and FastAPI world engine with React and TypeScript browser clients. The
                      world engine owns concrete facts and typed consequences. Resident identity and history persist
                      between private and shared spaces. Travel between independently operated computers remains a goal.
                    </>
                  ),
                },
                {
                  label: 'How tested and validated',
                  body: <>The repository provides root-level test and check commands.</>,
                },
                {
                  label: 'Result',
                  body: (
              ...
              sources={[{label: 'Inspect WorldWeaver', to: 'https://github.com/libardo667/worldweaver'}]}
            />
          </div>
        </section>
